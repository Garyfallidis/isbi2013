        ...
        for angular_th in [10, 20, 30]:
            for category in ['dti_', 'hardi_']:
                ...
                if os.path.exists(filepath):
                    ...
                    NC = 2
                    filename = '{}_pso_sticks_sel={}_NC={}_iso={}_fr={}_Np={}_Ni={}_snr={}_type={}'.format(category, 0, NC, iso, fr, Np, Ni, snr, typ)
                    sticks2 = nib.load('/media/Data/work/isbi2013/pso_sticks/' + filename + '.nii.gz').get_data()

                    NC = 3
                    filename = '{}_pso_sticks_sel={}_NC={}_iso={}_fr={}_Np={}_Ni={}_snr={}_type={}'.format(category, 0, NC, iso, fr, Np, Ni, snr, typ)
                    sticks3 = nib.load('/media/Data/work/isbi2013/pso_sticks/' + filename + '.nii.gz').get_data()
                    ...
                    nib.save(nib.Nifti1Image(peak_field, affine), '/media/Data/work/isbi2013/pso_sticks/' + filename2 + '.nii.gz')
