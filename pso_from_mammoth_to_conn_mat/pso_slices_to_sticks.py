                ...
                for typ in [5,6]:
                    for category in ['dti', 'hardi']:
                        ...
                        for slicez in range(50):
                            ...
                            filepath = '/media/Data/work/isbi2013/testing_data_result/pso_sticks_slices/' + filename + '.nii.gz'
                        ...
                        if cont:
                            ...
                            nib.save(nib.Nifti1Image(volume, affine), '/media/Data/work/isbi2013/testing_data_result/pso_sticks/' + filename + '.nii.gz')
