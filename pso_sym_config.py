...
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est1_1, npart, 4, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est2_1, npart, 8, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est3_1, npart, 12, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
#######################################
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est1_2_easy, npart, 4, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est2_2_easy, npart, 8, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est3_2_easy, npart, 12, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est1_2_tight, npart, 4, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est2_2_tight, npart, 8, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est3_2_tight, npart, 12, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
#######################################
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est1_3_easy, npart, 4, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est2_3_easy, npart, 8, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est3_3_easy, npart, 12, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est1_3_tight, npart, 4, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est2_3_tight, npart, 8, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
...
fvtk.show(r)
#######################################
pmm, fV = B_N_pso(metric_for_pso_B_N_est3_3_tight, npart, 12, niter, 0.75, 0.75, 0.75, soft_reset, good_enough, 1)
